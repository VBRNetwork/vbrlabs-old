...
MICROSERVICES = ["users", "authentication", "main"]
...
WSGI_APPLICATION = "vbrlabs.wsgi.application"
ASGI_APPLICATION = "vbrlabs.asgi.application"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://20.56.18.141:6379",
        "OPTIONS": {
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("20.56.18.141", 6379)],
        },
    },
}

DEFENDER_REDIS_URL = "redis://20.56.18.141:6379"
...
MEDIA_URL = "http://20.56.18.141:8000/api/media/"
